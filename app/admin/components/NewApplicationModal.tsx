      ...
      if (!error) {
        ...
        if (onAdd && error === null) {
          const newData = {
            ...
            address:
              `${formData.address_main} ${formData.address_detail}`.trim(),
            photo_url: photoUrl,
            id: new Date().getTime().toString(), // 임시 ID (실제로는 서버에서 반환)
            created_at: new Date().toISOString(),
          };
          onAdd(
            newData as NewApplication & { id: string; created_at: string } & {
              address: string;
            },
          );
        }
            ...
            <div style={{ display: "grid", gap: "16px" }}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, birth_prefix: e.target.value })
                  }
                  style={{
                    width: "100%",
                    padding: "12px",
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, address_main: e.target.value })
                  }
                  style={{
                    width: "100%",
                    padding: "12px",
                ...
                filteredCertificates.map((cert) => (
                  <label
                    ...
                    style={{
                      ...
                      borderRadius: "6px",
                      cursor: "pointer",
                      background: formData.certificates.includes(cert)
                        ? "#f0f4ff"
                        : "white",
                      transition: "all 0.2s",
                      fontSize: "12px",
            ...
            <div style={{ display: "grid", gap: "16px" }}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, mul_no: e.target.value })
                  }
                  style={{
                    width: "100%",
                    padding: "12px",
