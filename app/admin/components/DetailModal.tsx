...
const CERTIFICATE_CATEGORIES = [
  ...
  {
    label: '★필수★ 아동복지분야',
    options: ['지역아동교육지도사1급', '방과후돌봄교실지도사1급', '방과후학교지도사1급', '진로적성상담사1급', '심리상담사1급']
  },
  {
    label: '★필수★ 노인복지분야 2',
    options: ['진로적성상담사1급', '심리상담사1급', '독서지도사1급', '학교폭력예방상담사1급']
  },
  {
    label: '사회복지',
  ...
  {
    label: '보육과정',
    options: ['방과후아동지도사1급', '방과후돌봄교실지도사1급', '방과후수학지도사1급', '방과후학교지도사1급', '독서지도사1급', '진로적성상담사1급', '지역아동교육지도사1급', '동화구연지도사1급', '아동공예지도사1급', '아동요리지도사1급', '안전교육지도사1급', '아동미술심리상담사1급', '부모교육상담사1급', '디지털중독예방지도사1급']
  },
  {
    label: '교양수업',
  ...
  {
    label: '심리분야',
    options: ['심리상담사', '노인심리상담사', '아동미술심리상담사', '다문화심리상담사']
  },
  {
    label: '공통분야',
