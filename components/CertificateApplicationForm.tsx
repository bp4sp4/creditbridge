...
const CERTIFICATE_CATEGORIES = [
  ...
  {
    label: "공통분야",
    options: ["자원봉사지도사 1급", "심리상담사 1급", "안전관리사/안전교육지도사"],
  },
  {
    label: "사회복지 ",
    options: [
...
// =====================================================================
const PACKAGE_CERTS = ["간병사 1급", "베이비시터 1급", "가족상담사 1급"];
...
const ONE_PLUS_ONE_PAIRS: [string, string][] = [
  // ["안전관리사", "안전교육지도사"], // LMS 기준 "안전관리사/안전교육지도사" 한 과정으로 합침 → 짝 매칭 불필요
  ["아동미술심리상담사 1급", "아동미술지도사 1급"],
  ["지역아동교육지도사 1급", "아동교육지도사"],
  ["진로적성상담사", "진로직업상담사"],
  ["산모신생아건강관리사 1급", "산후관리사 1급"],
  // ["방과후수학지도사", "스토리텔링수학지도사"], // 미노출 처리 (2026-08-14)
  ["실버인지활동지도사 1급", "시니어인지활동지도사"],
  ["아동공예지도자1급", "토탈핸드크래프트"],
  // ["네일아트코디네이터 1급", "뷰티코디네이터"], // 미노출 처리 (2026-08-14)
  ["피부미용코디네이터 1급", "뷰티코디네이터"],
  ["헤어코디네이터 1급", "뷰티코디네이터"],
  ["메이크업코디네이터 1급", "뷰티코디네이터"],
];
